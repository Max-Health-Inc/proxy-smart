...
export function OAuthAnalyticsResponseToJSONTyped(value?: OAuthAnalyticsResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'topClients': value['topClients'] == null ? undefined : ((value['topClients'] as Array<any>).map(OAuthAnalyticsTopClientToJSON)),
        'flowsByType': value['flowsByType'],
        'errorsByType': value['errorsByType'],
        'hourlyStats': value['hourlyStats'] == null ? undefined : ((value['hourlyStats'] as Array<any>).map(OAuthAnalyticsHourlyStatsToJSON)),
