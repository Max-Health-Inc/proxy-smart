...
export interface CreateSmartAppRequest {
    ...
    fhirVersion?: string;
    /**
     * @type {CreateSmartAppRequestAppTypeEnum}
     * @memberof CreateSmartAppRequest
     */
    appType?: CreateSmartAppRequestAppTypeEnum;
    /**
     * @type {CreateSmartAppRequestClientTypeEnum}
     * @memberof CreateSmartAppRequest
     */
     ...
     * @type {CreateSmartAppRequestServerAccessTypeEnum}
     * @memberof CreateSmartAppRequest
     */
    ...
    /**
     * MCP server access control type (none = no MCP access, all-mcp-servers = access all, selected-mcp-servers = specific servers only)
     * @type {CreateSmartAppRequestMcpAccessTypeEnum}
     * @memberof CreateSmartAppRequest
     */
    mcpAccessType?: CreateSmartAppRequestMcpAccessTypeEnum;
    /**
     * List of allowed MCP server names (when mcpAccessType is selected-mcp-servers)
     * @type {Array<string>}
     * @memberof CreateSmartAppRequest
     */
 ...
 * @export
 */
export const CreateSmartAppRequestMcpAccessTypeEnum = {
    None: 'none',
    AllMcpServers: 'all-mcp-servers',
    SelectedMcpServers: 'selected-mcp-servers',
} as const;
export type CreateSmartAppRequestMcpAccessTypeEnum = typeof CreateSmartAppRequestMcpAccessTypeEnum[keyof typeof CreateSmartAppRequestMcpAccessTypeEnum];
