import { validateIPSSectionsLM } from "./IPSSectionsLM.js";
...
export class IPSSectionsLMClass {
    constructor(resource) {
        this.resource = resource;
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateIPSSectionsLM(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of IPSSectionsLM.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { id: randomId(), sectionProblems: { extension: [{ url: "http://hl7.org/fhir/StructureDefinition/data-absent-reason", valueCode: "unknown" }] }, sectionAllergies: { extension: [{ url: "http://hl7.org/fhir/StructureDefinition/data-absent-reason", valueCode: "unknown" }] }, sectionMedications: { extension: [{ url: "http://hl7.org/fhir/StructureDefinition/data-absent-reason", valueCode: "unknown" }] }, };
        ...
        enrichResource(base, 'Document', 'http://hl7.org/fhir/uv/ips/StructureDefinition/IPSSectionsLM', IPSSectionsLMClass._fieldPatterns, IPSSectionsLMClass._forbiddenFields, IPSSectionsLMClass.valueSetBindings, IPSSectionsLMClass._codeResolver, IPSSectionsLMClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new IPSSectionsLMClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
IPSSectionsLMClass._fieldPatterns = {};
/** Fields that are forbidden (max=0) in this profile - must not be generated */
IPSSectionsLMClass._forbiddenFields = [];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
IPSSectionsLMClass._fieldOrder = ["sectionProblems", "sectionAllergies", "sectionMedications", "sectionImmunizations", "sectionResults", "sectionProceduresHx", "sectionMedicalDevices", "sectionAdvanceDirectives", "sectionAlerts", "sectionFunctionalStatus", "sectionPastProblems", "sectionPregnancyHx", "sectionPatientStory", "sectionPlanOfCare", "sectionSocialHistory", "sectionVitalSigns"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
IPSSectionsLMClass.valueSetBindings = {};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
IPSSectionsLMClass._codeResolver = undefined;
