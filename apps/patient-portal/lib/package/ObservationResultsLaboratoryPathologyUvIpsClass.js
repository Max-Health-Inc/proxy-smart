import { validateObservationResultsLaboratoryPathologyUvIps } from "./ObservationResultsLaboratoryPathologyUvIps.js";
...
export class ObservationResultsLaboratoryPathologyUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-laboratory-pathology-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateObservationResultsLaboratoryPathologyUvIps(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of ObservationResultsLaboratoryPathologyUvIps.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'Observation', id: randomId(), status: "preliminary", category: [{ "coding": [{ "system": "http://terminology.hl7.org/CodeSystem/observation-category", "code": "laboratory" }] }], code: skeletonCodeableConcept('http://loinc.org', ['26436-6']), subject: { reference: 'Patient/' + randomId() }, effectiveDateTime: randomDate(), performer: [skeletonReference()], };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-laboratory-pathology-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Observation', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-laboratory-pathology-uv-ips', ObservationResultsLaboratoryPathologyUvIpsClass._fieldPatterns, ObservationResultsLaboratoryPathologyUvIpsClass._forbiddenFields, ObservationResultsLaboratoryPathologyUvIpsClass.valueSetBindings, ObservationResultsLaboratoryPathologyUvIpsClass._codeResolver, ObservationResultsLaboratoryPathologyUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new ObservationResultsLaboratoryPathologyUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
ObservationResultsLaboratoryPathologyUvIpsClass._fieldPatterns = {
    "category": {
        "coding": [
            {
...
ObservationResultsLaboratoryPathologyUvIpsClass._forbiddenFields = [];
...
ObservationResultsLaboratoryPathologyUvIpsClass.valueSetBindings = {
    "language": "http://hl7.org/fhir/ValueSet/languages|4.0.1",
    "status": "http://hl7.org/fhir/uv/ips/ValueSet/results-status-uv-ips",
    "category": "http://hl7.org/fhir/ValueSet/observation-category|4.0.1",
    "code": "http://hl7.org/fhir/uv/ips/ValueSet/results-laboratory-pathology-observations-uv-ips",
    "subject.type": "http://hl7.org/fhir/ValueSet/resource-types|4.0.1",
    "value[x]": "http://hl7.org/fhir/uv/ips/ValueSet/results-coded-values-laboratory-pathology-uv-ips",
...
ObservationResultsLaboratoryPathologyUvIpsClass._codeResolver = (() => {
