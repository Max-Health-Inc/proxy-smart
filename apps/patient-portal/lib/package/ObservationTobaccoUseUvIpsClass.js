import { validateObservationTobaccoUseUvIps } from "./ObservationTobaccoUseUvIps.js";
...
export class ObservationTobaccoUseUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-tobaccouse-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateObservationTobaccoUseUvIps(this.resource, options);
    }
    getResource() {
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'Observation', id: randomId(), status: "final", code: skeletonCodeableConcept('http://loinc.org', ['72166-2']), subject: { reference: 'Patient/' + randomId() }, effectiveDateTime: randomDate(), };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-tobaccouse-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Observation', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-tobaccouse-uv-ips', ObservationTobaccoUseUvIpsClass._fieldPatterns, ObservationTobaccoUseUvIpsClass._forbiddenFields, ObservationTobaccoUseUvIpsClass.valueSetBindings, ObservationTobaccoUseUvIpsClass._codeResolver, ObservationTobaccoUseUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new ObservationTobaccoUseUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
ObservationTobaccoUseUvIpsClass._fieldPatterns = {
    "code": {
        "coding": [
            {
...
ObservationTobaccoUseUvIpsClass._forbiddenFields = ["component"];
...
ObservationTobaccoUseUvIpsClass.valueSetBindings = {
    ...
    "value[x]": "http://hl7.org/fhir/uv/ips/ValueSet/current-smoking-status-uv-ips",
...
ObservationTobaccoUseUvIpsClass._codeResolver = (() => {
