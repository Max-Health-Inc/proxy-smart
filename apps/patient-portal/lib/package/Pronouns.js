...
export async function validatePronouns(resource, options) {
    const errors = [];
    const warnings = [];
    ...
    if (resource.url !== undefined && resource.url !== "http://hl7.org/fhir/StructureDefinition/individual-pronouns") {
        errors.push("url must have the fixed value 'http://hl7.org/fhir/StructureDefinition/individual-pronouns'");
    }
