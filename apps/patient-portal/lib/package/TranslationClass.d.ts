...
export declare class TranslationClass {
    private resource;
    ...
    constructor(resource: Translation);
    ...
    setResource(resource: Translation): void;
    /**
     * Returns a plain JSON clone of the underlying resource ONLY if the last validation succeeded with zero errors.
     * Call validate() first; otherwise this method throws to prevent accidental use of invalid / unchecked data.
     */
    toJSON(): Promise<Translation>;
    /**
     * Create an empty instance for parity testing: for true FHIR resources, includes only resourceType; for datatypes, returns an empty object.
     * Note: meta.profile (when applicable) will be ensured by the constructor when wrapping this resource.
     */
    static empty(overrides?: Partial<Translation>): Translation;
    /**
     * Create a minimal randomized instance of Translation.
     * Populates id, resourceType (if applicable) and primitive required (min>0) top-level fields with placeholders.
     */
    static random(overrides?: Partial<Translation>, opts?: {
        seed?: number;
    }): Translation;
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides?: Partial<Translation>, opts?: {
        seed?: number;
    }): TranslationClass;
}
