import { validateObservationResultsRadiologyUvIps } from "./ObservationResultsRadiologyUvIps.js";
...
export class ObservationResultsRadiologyUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-radiology-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateObservationResultsRadiologyUvIps(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of ObservationResultsRadiologyUvIps.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'Observation', id: randomId(), status: "preliminary", category: [{ "coding": [{ "system": "http://terminology.hl7.org/CodeSystem/observation-category", "code": "imaging" }] }], code: skeletonCodeableConcept('http://loinc.org', ['26436-6']), subject: { reference: 'Patient/' + randomId() }, effectiveDateTime: randomDate(), performer: [skeletonReference()], };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-radiology-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Observation', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-radiology-uv-ips', ObservationResultsRadiologyUvIpsClass._fieldPatterns, ObservationResultsRadiologyUvIpsClass._forbiddenFields, ObservationResultsRadiologyUvIpsClass.valueSetBindings, ObservationResultsRadiologyUvIpsClass._codeResolver, ObservationResultsRadiologyUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new ObservationResultsRadiologyUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
ObservationResultsRadiologyUvIpsClass._fieldPatterns = {
    "category": {
        "coding": [
            {
...
ObservationResultsRadiologyUvIpsClass._forbiddenFields = [];
...
ObservationResultsRadiologyUvIpsClass.valueSetBindings = {
    ...
    "code": "http://hl7.org/fhir/uv/ips/ValueSet/results-radiology-observations-uv-ips",
    ...
    "component.code": "http://hl7.org/fhir/uv/ips/ValueSet/results-radiology-component-uv-ips",
...
ObservationResultsRadiologyUvIpsClass._codeResolver = (() => {
