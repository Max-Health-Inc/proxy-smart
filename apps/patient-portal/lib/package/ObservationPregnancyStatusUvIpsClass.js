import { validateObservationPregnancyStatusUvIps } from "./ObservationPregnancyStatusUvIps.js";
...
export class ObservationPregnancyStatusUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-pregnancy-status-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateObservationPregnancyStatusUvIps(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of ObservationPregnancyStatusUvIps.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'Observation', id: randomId(), status: "final", code: skeletonCodeableConcept('http://loinc.org', ['82810-3']), subject: { reference: 'Patient/' + randomId() }, effectiveDateTime: randomDate(), };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-pregnancy-status-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Observation', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-pregnancy-status-uv-ips', ObservationPregnancyStatusUvIpsClass._fieldPatterns, ObservationPregnancyStatusUvIpsClass._forbiddenFields, ObservationPregnancyStatusUvIpsClass.valueSetBindings, ObservationPregnancyStatusUvIpsClass._codeResolver, ObservationPregnancyStatusUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new ObservationPregnancyStatusUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
ObservationPregnancyStatusUvIpsClass._fieldPatterns = {
    "code": {
        "coding": [
            {
    ...
    "hasMember.type": "ImplementationGuide",
...
ObservationPregnancyStatusUvIpsClass._forbiddenFields = ["bodySite", "specimen", "device", "referenceRange", "component"];
...
ObservationPregnancyStatusUvIpsClass.valueSetBindings = {
    ...
    "code": "http://hl7.org/fhir/ValueSet/observation-codes|4.0.1",
    "subject.type": "http://hl7.org/fhir/ValueSet/resource-types|4.0.1",
    "value[x]": "http://hl7.org/fhir/uv/ips/ValueSet/pregnancy-status-uv-ips",
    ...
    "hasMember.type": "http://hl7.org/fhir/ValueSet/resource-types|4.0.1",
...
ObservationPregnancyStatusUvIpsClass._codeResolver = (() => {
