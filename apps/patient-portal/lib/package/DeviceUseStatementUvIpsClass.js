import { validateDeviceUseStatementUvIps } from "./DeviceUseStatementUvIps.js";
// Only import helpers actually referenced below (dynamic based on required fields)
import { randomId, setRandomSeed, enrichResource, skeletonReference, skeletonPeriod } from "./random/index.js";
...
export class DeviceUseStatementUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/DeviceUseStatement-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateDeviceUseStatementUvIps(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of DeviceUseStatementUvIps.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'DeviceUseStatement', id: randomId(), status: "stopped", subject: { reference: 'Patient/' + randomId() }, timingPeriod: skeletonPeriod(), device: skeletonReference(), };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/DeviceUseStatement-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'DeviceUseStatement', 'http://hl7.org/fhir/uv/ips/StructureDefinition/DeviceUseStatement-uv-ips', DeviceUseStatementUvIpsClass._fieldPatterns, DeviceUseStatementUvIpsClass._forbiddenFields, DeviceUseStatementUvIpsClass.valueSetBindings, DeviceUseStatementUvIpsClass._codeResolver, DeviceUseStatementUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new DeviceUseStatementUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
DeviceUseStatementUvIpsClass._fieldPatterns = {
    "subject.type": "ImplementationGuide",
    "_refReq_subject": {
        "reference": true
    },
    "_choiceType_timing[x]": [
        "Period",
        "dateTime"
    ]
};
/** Fields that are forbidden (max=0) in this profile - must not be generated */
DeviceUseStatementUvIpsClass._forbiddenFields = [];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
DeviceUseStatementUvIpsClass._fieldOrder = ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "basedOn", "status", "subject", "derivedFrom", "timing[x]", "recordedOn", "source", "device", "reasonCode", "reasonReference", "bodySite", "note"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
DeviceUseStatementUvIpsClass.valueSetBindings = {
    "language": "http://hl7.org/fhir/ValueSet/languages|4.0.1",
    "status": "http://hl7.org/fhir/ValueSet/device-statement-status|4.0.1",
...
DeviceUseStatementUvIpsClass._codeResolver = (() => {
