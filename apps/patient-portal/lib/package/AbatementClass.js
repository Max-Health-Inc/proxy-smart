import { validateAbatement } from "./Abatement.js";
...
export class AbatementClass {
    constructor(resource) {
        this.resource = resource;
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateAbatement(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of Abatement.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { id: randomId(), url: "http://hl7.org/fhir/StructureDefinition/allergyintolerance-abatement", valueDateTime: randomDate(), };
        ...
        enrichResource(base, 'Extension', 'http://hl7.org/fhir/StructureDefinition/allergyintolerance-abatement', AbatementClass._fieldPatterns, AbatementClass._forbiddenFields, AbatementClass.valueSetBindings, AbatementClass._codeResolver, AbatementClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new AbatementClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
AbatementClass._fieldPatterns = {
    "url": "http://hl7.org/fhir/StructureDefinition/allergyintolerance-abatement",
    "_choiceType_value[x]": [
        "dateTime",
        "Age",
...
AbatementClass._forbiddenFields = ["extension"];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
AbatementClass._fieldOrder = ["id", "extension", "url", "value[x]"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
AbatementClass.valueSetBindings = {};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
AbatementClass._codeResolver = undefined;
