...
export class CodeableConceptIPSClass {
    constructor(resource) {
        this.resource = resource;
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateCodeableConceptIPS(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of CodeableConceptIPS.
    ...
    static random(overrides = {}, opts) {
        ...
        enrichResource(base, 'CodeableConcept', 'http://hl7.org/fhir/uv/ips/StructureDefinition/CodeableConcept-uv-ips', CodeableConceptIPSClass._fieldPatterns, CodeableConceptIPSClass._forbiddenFields, CodeableConceptIPSClass.valueSetBindings, CodeableConceptIPSClass._codeResolver, CodeableConceptIPSClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new CodeableConceptIPSClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
CodeableConceptIPSClass._fieldPatterns = {};
/** Fields that are forbidden (max=0) in this profile - must not be generated */
CodeableConceptIPSClass._forbiddenFields = [];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
CodeableConceptIPSClass._fieldOrder = ["id", "extension", "coding", "text"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
CodeableConceptIPSClass.valueSetBindings = {};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
CodeableConceptIPSClass._codeResolver = undefined;
