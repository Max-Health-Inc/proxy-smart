import { PractitionerRoleUvIps } from "./PractitionerRoleUvIps.js";
import type { ValidatorOptions } from "./ValidatorOptions.js";
export declare class PractitionerRoleUvIpsClass {
    private resource;
    /** Pattern constraints for profile fields (used by random() generator) */
    protected static readonly _fieldPatterns: {
        "availableTime.daysOfWeek": string;
    ...
    constructor(resource: PractitionerRoleUvIps);
    /** Validate current resource instance. */
    validate(options?: ValidatorOptions): Promise<{
        errors: string[];
        warnings: string[];
    }>;
    getResource(): PractitionerRoleUvIps;
    setResource(resource: PractitionerRoleUvIps): void;
    /**
     * Returns a plain JSON clone of the underlying resource ONLY if the last validation succeeded with zero errors.
     * Call validate() first; otherwise this method throws to prevent accidental use of invalid / unchecked data.
     */
    toJSON(): Promise<PractitionerRoleUvIps>;
    /**
     * Create an empty instance for parity testing: for true FHIR resources, includes only resourceType; for datatypes, returns an empty object.
     * Note: meta.profile (when applicable) will be ensured by the constructor when wrapping this resource.
     */
    static empty(overrides?: Partial<PractitionerRoleUvIps>): PractitionerRoleUvIps;
    /**
     * Create a minimal randomized instance of PractitionerRoleUvIps.
     * Populates id, resourceType (if applicable) and primitive required (min>0) top-level fields with placeholders.
     */
    static random(overrides?: Partial<PractitionerRoleUvIps>, opts?: {
        seed?: number;
    }): PractitionerRoleUvIps;
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides?: Partial<PractitionerRoleUvIps>, opts?: {
        seed?: number;
