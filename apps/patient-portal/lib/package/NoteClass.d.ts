...
export declare class NoteClass {
    ...
    getResource(): Note;
    setResource(resource: Note): void;
    /**
     ...
     */
    static empty(overrides?: Partial<Note>): Note;
    /**
     * Create a minimal randomized instance of Note.
     * Populates id, resourceType (if applicable) and primitive required (min>0) top-level fields with placeholders.
     */
    static random(overrides?: Partial<Note>, opts?: {
        seed?: number;
    }): Note;
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides?: Partial<Note>, opts?: {
        seed?: number;
    }): NoteClass;
}
