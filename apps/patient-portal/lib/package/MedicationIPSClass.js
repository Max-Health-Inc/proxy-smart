import { validateMedicationIPS } from "./MedicationIPS.js";
...
export class MedicationIPSClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Medication-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateMedicationIPS(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of MedicationIPS.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'Medication', id: randomId(), code: skeletonCodeableConcept('http://www.nlm.nih.gov/research/umls/rxnorm', ['1049502']), };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Medication-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Medication', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Medication-uv-ips', MedicationIPSClass._fieldPatterns, MedicationIPSClass._forbiddenFields, MedicationIPSClass.valueSetBindings, MedicationIPSClass._codeResolver, MedicationIPSClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new MedicationIPSClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
MedicationIPSClass._fieldPatterns = {
    "_refReq_ingredient": {
        "itemCodeableConcept-uv-ips": true,
        "itemCodeableConcept": true
    }
};
/** Fields that are forbidden (max=0) in this profile - must not be generated */
MedicationIPSClass._forbiddenFields = [];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
MedicationIPSClass._fieldOrder = ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "code", "status", "manufacturer", "form", "amount", "ingredient", "batch"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
MedicationIPSClass.valueSetBindings = {
    "language": "http://hl7.org/fhir/ValueSet/languages|4.0.1",
    "code": "http://hl7.org/fhir/uv/ips/ValueSet/medication-uv-ips",
    "status": "http://hl7.org/fhir/ValueSet/medication-status|4.0.1",
    "form": "http://hl7.org/fhir/ValueSet/medication-form-codes",
    "ingredient.item[x]": "http://hl7.org/fhir/uv/ips/ValueSet/medicine-active-substances-uv-ips"
};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
MedicationIPSClass._codeResolver = (() => {
