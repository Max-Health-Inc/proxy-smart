import { validatePriority } from "./Priority.js";
...
export class PriorityClass {
    ...
    async validate(options) {
        return validatePriority(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of Priority.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { id: randomId(), url: "http://hl7.org/fhir/StructureDefinition/flag-priority", valueCodeableConcept: { coding: [{ system: "http://hl7.org/fhir/flag-priority-code", code: "PH" }] }, };
        ...
        enrichResource(base, 'Extension', 'http://hl7.org/fhir/StructureDefinition/flag-priority', PriorityClass._fieldPatterns, PriorityClass._forbiddenFields, PriorityClass.valueSetBindings, PriorityClass._codeResolver, PriorityClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new PriorityClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
PriorityClass._fieldPatterns = {
    "url": "http://hl7.org/fhir/StructureDefinition/flag-priority",
    "_choiceType_value[x]": [
        "CodeableConcept"
    ]
...
PriorityClass._forbiddenFields = ["extension"];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
PriorityClass._fieldOrder = ["id", "extension", "url", "value[x]"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
PriorityClass.valueSetBindings = {
    "value[x]": "http://hl7.org/fhir/ValueSet/flag-priority"
};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
PriorityClass._codeResolver = (() => {
