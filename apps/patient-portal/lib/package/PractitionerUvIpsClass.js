import { validatePractitionerUvIps } from "./PractitionerUvIps.js";
// Only import helpers actually referenced below (dynamic based on required fields)
import { randomId, setRandomSeed, enrichResource, skeletonHumanName } from "./random/index.js";
...
export class PractitionerUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Practitioner-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validatePractitionerUvIps(this.resource, options);
    }
    getResource() {
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'Practitioner', id: randomId(), name: [skeletonHumanName()], };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Practitioner-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Practitioner', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Practitioner-uv-ips', PractitionerUvIpsClass._fieldPatterns, PractitionerUvIpsClass._forbiddenFields, PractitionerUvIpsClass.valueSetBindings, PractitionerUvIpsClass._codeResolver, PractitionerUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new PractitionerUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
PractitionerUvIpsClass._fieldPatterns = {
    "name.use": "maiden",
    "qualification.code": "MME",
    "_refReq_qualification": {
        "code": true
    }
};
/** Fields that are forbidden (max=0) in this profile - must not be generated */
PractitionerUvIpsClass._forbiddenFields = [];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
PractitionerUvIpsClass._fieldOrder = ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "active", "name", "telecom", "address", "gender", "birthDate", "photo", "qualification", "communication"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
PractitionerUvIpsClass.valueSetBindings = {
    ...
    "qualification.code": "http://terminology.hl7.org/ValueSet/v2-2.7-0360",
    "communication": "http://hl7.org/fhir/ValueSet/languages|4.0.1"
};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
PractitionerUvIpsClass._codeResolver = (() => {
