import { validateMedicationRequestIPS } from "./MedicationRequestIPS.js";
...
export class MedicationRequestIPSClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationRequest-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateMedicationRequestIPS(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of MedicationRequestIPS.
    ...
    static random(overrides = {}, opts) {
        ...
        const base = { resourceType: 'MedicationRequest', id: randomId(), status: "draft", intent: "proposal", medicationCodeableConcept: skeletonCodeableConcept('http://www.nlm.nih.gov/research/umls/rxnorm', ['313782']), subject: { reference: 'Patient/' + randomId() }, };
        // Always include meta.profile with this profile's canonical URL if available & only for resource profiles
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationRequest-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'MedicationRequest', 'http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationRequest-uv-ips', MedicationRequestIPSClass._fieldPatterns, MedicationRequestIPSClass._forbiddenFields, MedicationRequestIPSClass.valueSetBindings, MedicationRequestIPSClass._codeResolver, MedicationRequestIPSClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new MedicationRequestIPSClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
MedicationRequestIPSClass._fieldPatterns = {
    "subject.type": "ImplementationGuide",
    "dosageInstruction.additionalInstruction": "418577003",
    "dosageInstruction.site": "344001",
    "dosageInstruction.route": "418331006",
    "dosageInstruction.method": "422033008",
    "dosageInstruction.doseAndRate.type": "calculated",
    "substitution.reason": "FP",
    "_refReq_subject": {
        "reference": true
    },
...
MedicationRequestIPSClass._forbiddenFields = [];
/** FHIR element ordering for this profile's base resource (used by enrichResource for correct JSON field order) */
MedicationRequestIPSClass._fieldOrder = ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "statusReason", "intent", "category", "priority", "doNotPerform", "reported[x]", "medication[x]", "subject", "encounter", "supportingInformation", "authoredOn", "requester", "performer", "performerType", "recorder", "reasonCode", "reasonReference", "instantiatesCanonical", "instantiatesUri", "basedOn", "groupIdentifier", "courseOfTherapyType", "insurance", "note", "dosageInstruction", "dispenseRequest", "substitution", "priorPrescription", "detectedIssue", "eventHistory"];
/** ValueSet bindings for coded fields - maps field name to ValueSet URL */
MedicationRequestIPSClass.valueSetBindings = {
    "language": "http://hl7.org/fhir/ValueSet/languages|4.0.1",
    "status": "http://hl7.org/fhir/ValueSet/medicationrequest-status|4.0.1",
    "statusReason": "http://hl7.org/fhir/ValueSet/medicationrequest-status-reason|4.0.1",
    "intent": "http://hl7.org/fhir/ValueSet/medicationrequest-intent|4.0.1",
    "category": "http://hl7.org/fhir/ValueSet/medicationrequest-category|4.0.1",
    ...
    "performerType": "http://hl7.org/fhir/ValueSet/performer-role|4.0.1",
    "reasonCode": "http://hl7.org/fhir/ValueSet/condition-code|4.0.1",
    "courseOfTherapyType": "http://hl7.org/fhir/ValueSet/medicationrequest-course-of-therapy|4.0.1",
    "dosageInstruction.additionalInstruction": "http://hl7.org/fhir/ValueSet/additional-instruction-codes|4.0.1",
    "dosageInstruction.asNeeded[x]": "http://hl7.org/fhir/ValueSet/medication-as-needed-reason|4.0.1",
    "dosageInstruction.site": "http://hl7.org/fhir/ValueSet/approach-site-codes|4.0.1",
    "dosageInstruction.route": "http://hl7.org/fhir/ValueSet/route-codes",
    "dosageInstruction.method": "http://hl7.org/fhir/ValueSet/administration-method-codes|4.0.1",
    "dosageInstruction.doseAndRate.type": "http://hl7.org/fhir/ValueSet/dose-rate-type|4.0.1",
...
MedicationRequestIPSClass._codeResolver = (() => {
