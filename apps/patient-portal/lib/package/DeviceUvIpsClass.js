import { validateDeviceUvIps } from "./DeviceUvIps.js";
...
export class DeviceUvIpsClass {
    constructor(resource) {
        this.resource = resource;
        ensureProfile(this.resource, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Device-uv-ips');
    }
    /** Validate current resource instance. */
    async validate(options) {
        return validateDeviceUvIps(this.resource, options);
    }
    getResource() {
    ...
    /**
     * Create a minimal randomized instance of DeviceUvIps.
    ...
    static random(overrides = {}, opts) {
        ...
        ensureProfile(base, 'http://hl7.org/fhir/uv/ips/StructureDefinition/Device-uv-ips');
        // Enrich the base resource with common fields using centralized enrichment logic
        enrichResource(base, 'Device', 'http://hl7.org/fhir/uv/ips/StructureDefinition/Device-uv-ips', DeviceUvIpsClass._fieldPatterns, DeviceUvIpsClass._forbiddenFields, DeviceUvIpsClass.valueSetBindings, DeviceUvIpsClass._codeResolver, DeviceUvIpsClass._fieldOrder);
        // Cast through unknown to acknowledge dynamic enrichment
        return { ...base, ...overrides };
    }
    /** Convenience: returns a class instance wrapping a randomized resource. */
    static randomClass(overrides = {}, opts) {
        return new DeviceUvIpsClass(this.random(overrides, opts));
    }
}
/** Pattern constraints for profile fields (used by random() generator) */
DeviceUvIpsClass._fieldPatterns = {
...
DeviceUvIpsClass.valueSetBindings = {
    ...
    "type": "http://hl7.org/fhir/uv/ips/ValueSet/medical-devices-uv-ips"
};
/** Code resolver for ValueSet bindings - returns a random valid code from a ValueSet by URL */
DeviceUvIpsClass._codeResolver = (() => {
