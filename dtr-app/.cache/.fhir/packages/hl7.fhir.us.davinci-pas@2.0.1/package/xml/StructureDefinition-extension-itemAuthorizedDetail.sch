...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'productOrServiceCode']) &lt;= 1">extension with URL = 'productOrServiceCode': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'unitPrice']) &lt;= 1">extension with URL = 'unitPrice': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'revenue']) &lt;= 1">extension with URL = 'revenue': maximum cardinality of 'extension' is 1</sch:assert>
