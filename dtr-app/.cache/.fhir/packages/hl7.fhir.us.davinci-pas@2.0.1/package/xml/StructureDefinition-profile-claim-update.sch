...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile PASClaim
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim/f:supportingInfo">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/davinci-pas/StructureDefinition/extension-infoChanged']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/davinci-pas/StructureDefinition/extension-infoChanged': maximum cardinality of 'extension' is 1</sch:assert>
